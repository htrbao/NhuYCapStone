...
# def genetic_algorithm(num_generations = 100, population_size = 100, crossover_probability = 0.8, mutation_probability = 0.2):
...
a = Chromosome("Genetic")
a.gene = [16, 5, 4, 14, 20, 7, 9, 2, 19, 18, 11, 12, 8, 15, 13, 6, 3, 17, 1, 10]
